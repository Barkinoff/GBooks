...
namespace GBooks.Infrastructure.Migrations
{
    ...
    [Migration("20240131161859_AddedSomeEntites")]
    partial class AddedSomeEntites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GBooks.Domain.Commons.Language", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GBooks.Domain.Entites.Order.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GBooks.Domain.Entites.Order.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GBooks.Domain.Entites.Books.Book", b =>
                {
                    ...
                    b.HasOne("GBooks.Domain.Commons.Language", "Language")
                        .WithOne()
            ...
            modelBuilder.Entity("GBooks.Domain.Entites.Order.Order", b =>
                {
                    b.HasOne("GBooks.Domain.Entites.Addresses.Address", "Address")
                        .WithOne()
                        .HasForeignKey("GBooks.Domain.Entites.Order.Order", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GBooks.Domain.Entites.Payments.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("GBooks.Domain.Entites.Order.Order", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GBooks.Domain.Entites.Supliers.Suplier", "Suplier")
                        .WithOne()
                        .HasForeignKey("GBooks.Domain.Entites.Order.Order", "SuplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GBooks.Domain.Entites.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("GBooks.Domain.Entites.Order.Order", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
